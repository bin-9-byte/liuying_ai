...
type FolderColor = "blue" | "black" | "grey" | "yellow" | "orange" | "red" | "violet";
...
> = {
  ...
  lg: {
    container: "size-36 rounded-[36px]",
...
> = {
  ...
  violet: {
    folder: "from-violet-400 to-violet-500",
    flap: "bg-violet-300/50",
    paperBack: "bg-violet-100/60",
    paperFront: "bg-violet-50",
    paperLine: "bg-violet-300/40",
    paperBorder: "border-violet-200",
    labelBg: "bg-violet-900/20",
    folderBorder: "border-white/30",
  },
};

const FOLDER_COLORS: FolderColor[] = ["blue", "orange", "yellow", "red", "grey", "black"];
